    ...
    properties:
      ...
      user_data:
         {get_file: "./pan.tgz.base64"}
          #/config/bootstrap.xml: {get_file: "./config/bootstrap.xml"}
          #/license/authcodes: {get_file: "./config/authcodes"}
...
openstack stack create -f yaml -t pan.yml --parameter mgmt_network=PN-INET --parameter public_network=public --parameter pan_flavor=PA-VM-50 --parameter pan_image=PAvFW_8_1_17_MQ PAN-FW-01
```
